...
public class LocalPreferencePage
	...
	public void createFieldEditors() {
		addField(new DirectoryFieldEditor(PreferenceConstants.P_LOCAL_PATH_STRING, 
				"&Hybris Data Directory :", getFieldEditorParent()));
		
		
		addField(new FileFieldEditor(PreferenceConstants.P_MYSQL_PATH, 
